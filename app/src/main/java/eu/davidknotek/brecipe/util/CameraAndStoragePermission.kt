    ...
    private val cameraPermissionRequest =
        fragment.registerForActivityResult(ActivityResultContracts.RequestPermission()) { isGranted ->
            if (isGranted) {
                ...
                Toast.makeText(fragment.context, fragment.getString(R.string.denied_permission), Toast.LENGTH_SHORT).show()
            }
        }
...
//                openGalleryWindow()
//            } else {
//                Toast.makeText(fragment.context, fragment.getString(R.string.denied_permission), Toast.LENGTH_SHORT)
//                    .show()
//            }
//        }
    ...
    fun checkPermissionsCamera(imageView: ImageView) {
        ...
        when {
            ...
            ActivityCompat.shouldShowRequestPermissionRationale(
                ...
                showRationaleDialog(
                    fragment.getString(R.string.camera_permission_required),
                    fragment.getString(R.string.camera_is_denied)) {
...
//    }
    ...
    private fun showRationaleDialog(title: String, message: String, launchPermission: () -> Unit) {
        ...
        builder.setTitle(title)
            .setMessage(message)
            .setPositiveButton(fragment.getString(R.string.ok)) { dialog, _ ->
                dialog.dismiss()
                launchPermission()
            }
