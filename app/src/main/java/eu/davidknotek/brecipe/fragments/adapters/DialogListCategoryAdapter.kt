 ...
 */
class DialogListCategoryAdapter(private val onClickListener: (Category) -> Unit) :
    RecyclerView.Adapter<DialogListCategoryAdapter.MyViewHolder>() {
    private var categories = emptyList<Category>()

    class MyViewHolder(val binding: RowCategoryDialogBinding) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.binding.categoryCargView.setOnClickListener {
            onClickListener(currentCategory)
        }
    }
